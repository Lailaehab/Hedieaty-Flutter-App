...
class FCMService {
  ...
  static Future<FCMService> initialize() async {
    final String jsonString = await rootBundle.loadString(
      'hedieaty-d79be-firebase-adminsdk-cg8cr-c0d6179fe9.json',
    );
  ...
  static void onNotificationRecieved(RemoteMessage message)async {
    ...
    final DatabaseHelper _databaseHelper = DatabaseHelper();
      try {
    await _databaseHelper.updateGiftStatus(giftId, status);
    print('Gift status updated successfully in the local database.');
  } catch (e) {
    print('Failed to update gift status: $e');
  }
